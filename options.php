...
function themedy_settings_init(  ) { 
	...
	add_settings_section(
		'themedy_pluginPage_section_fontAwesome', 
		__( 'FontAwesome Loading', 'themedy' ), 
		'themedy_settings_section_callback_fontAwesome', 
		'pluginPage'
	);

	add_settings_section(
		'themedy_pluginPage_section_fontello', 
		__( 'Fontello Loading', 'themedy' ), 
		'themedy_settings_section_callback_fontello', 
		'pluginPage'
	);
	...
	add_settings_field( 
		'themedy_checkbox_field_2', 
		__( 'Unload FontAwesome', 'themedy' ), 
		'themedy_checkbox_field_2_render', 
		'pluginPage', 
		'themedy_pluginPage_section_fontAwesome' 
	);

	add_settings_field( 
		'themedy_checkbox_field_3', 
		__( 'Unload Fontello', 'themedy' ), 
		'themedy_checkbox_field_3_render', 
		'pluginPage', 
		'themedy_pluginPage_section_fontello' 
	);
...
function themedy_checkbox_field_2_render(  ) { 
	$options = get_option( 'themedy_settings' );

	?>
	<input type='checkbox' name='themedy_settings[themedy_checkbox_field_2]' <?php if(isset($options['themedy_checkbox_field_2'])) {checked( $options['themedy_checkbox_field_2'], 1 );} ?> value='1'>

	<?php 

}

function themedy_checkbox_field_3_render(  ) { 
	$options = get_option( 'themedy_settings' );

	?>
	<input type='checkbox' name='themedy_settings[themedy_checkbox_field_3]' <?php if(isset($options['themedy_checkbox_field_3'])) {checked( $options['themedy_checkbox_field_3'], 1 );} ?> value='1'>
...
function themedy_settings_section_callback_fontAwesome(  ) { 

	echo __( 'If another plugin is already loading FontAwesome, you can unload ours by checking this box.', 'themedy' );

}

function themedy_settings_section_callback_fontello(  ) { 

	echo __( 'If you are not using our Social shortcode ([themedy_social]), you can unload the Fontello CSS file by checking this box.', 'themedy' );
