...
function themedy_shortcodes_button($atts, $content = null) {
	...
	$url = esc_url($url);
	$icon = esc_attr($icon);
	$font_awesome_att = esc_attr($font_awesome_att);
	$label = esc_html($label);
	$colour = esc_attr($colour);
	$colour_custom = esc_attr($colour_custom);
	$size = esc_attr($size);
	$edge = esc_attr($edge);
...
function themedy_shortcodes_alertbox($atts, $content = null) {
	...
	$colour = esc_attr($colour);
	$font_awesome_att = esc_attr($font_awesome_att);
	$custom_colour = esc_attr($custom_colour);
