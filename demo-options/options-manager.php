...
class Options_Manager {
    ...
    /**
     * Create plugin menu.
     * Note for dev, turn off internal Themedy Replicate plugin before debugging this area.
     */
    public function add_menu_page() {
        add_options_page( __( 'Themedy Replicate', 'themedy' ), __( 'Themedy Replicate', 'themedy' ), 'edit_theme_options', 'themedy-replicate', array( &$this, 'settings_page' ) );
    }
