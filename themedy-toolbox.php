...
function themedy_shortcodes_add_scripts() {
	...
	if(!isset($options['themedy_checkbox_field_2'])) {
		wp_enqueue_style('font-awesome', '//stackpath.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css', '4.7.0');
	}

	if(!isset($options['themedy_checkbox_field_3'])) {
